...
TM_MPU6050_Result_t TM_MPU6050_ReadAll(TM_MPU6050_t* DataStruct) {
	...
	DataStruct->Accelerometer_X = (int16_t)(data[0] << 8 | data[1])/16384.0f;	
	DataStruct->Accelerometer_Y = (int16_t)(data[2] << 8 | data[3])/16384.0f;
	DataStruct->Accelerometer_Z = (int16_t)(data[4] << 8 | data[5])/16384.0f;

	/* Format temperature */
	temp = (data[6] << 8 | data[7]);
	DataStruct->Temperature = (float)((float)((int16_t)temp) / 340.0f + 36.53f);
	
	/* Format gyroscope data */
	DataStruct->Gyroscope_X = (int16_t)(data[8] << 8 | data[9])/131.0f;
	DataStruct->Gyroscope_Y = (int16_t)(data[10] << 8 | data[11])/131.0f;
	DataStruct->Gyroscope_Z = (int16_t)(data[12] << 8 | data[13])/131.0f;
